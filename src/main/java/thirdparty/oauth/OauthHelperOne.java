...
public class OauthHelperOne implements OauthHelper {
	// 不会变的参数
	private static final Logger LOGGER = LoggerFactory
			.getLogger(OauthHelperOne.class);
	...
	public OauthHelperOne(AppToken appToken) {
		this.appToken = appToken;
	}

	public OauthHelperOne(String appKey, String appSecret) {
