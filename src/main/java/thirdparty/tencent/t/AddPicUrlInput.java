...
public class AddPicUrlInput extends TencentInput {

	final private static String apiURL = "http://open.t.qq.com/api/t/add_pic_url";
	...
	private String pic_url;//视频url地址，后台自动分析视频信息，支持youku,tudou,ku6等（URL最长不能超过1024字节）
	...
	public AddPicUrlInput(String access_token,String access_secret,String content, String pic_url, String clientip){
		...
		bodyArgs.add(new Arg("pic_url",pic_url));
