...
public class ReAddInput extends TencentInput {

	final private static String apiURL = "http://open.t.qq.com/api/t/re_add";
	...
	public ReAddInput(String access_token,String access_secret,String content, String clientip, String reid){
