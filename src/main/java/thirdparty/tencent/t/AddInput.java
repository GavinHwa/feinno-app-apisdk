...
public class AddInput extends TencentInput {

	final private static String apiURL = "http://open.t.qq.com/api/t/add";
	...
	public AddInput(String access_token,String access_secret,String content, String clientip){
