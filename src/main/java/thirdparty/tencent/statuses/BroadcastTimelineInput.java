...
public class BroadcastTimelineInput extends TencentInput {
	
	final private static String apiURL = "http://open.t.qq.com/api/statuses/broadcast_timeline";
	 ...
	 * @param reqnum
	 */
	public BroadcastTimelineInput(String access_token,String access_secret,int reqnum){
		this.pagetime = 0;
		this.reqnum = reqnum;
	 ...
	 * @param access_secret
	 */
	public BroadcastTimelineInput(String access_token,String access_secret){
		this.userAccessToken = new AccessToken(access_token, access_secret);
		httpMethod = "GET";
