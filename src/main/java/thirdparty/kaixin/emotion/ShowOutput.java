...
import thirdparty.kaixin.Emotion;
import thirdparty.kaixin.KaixinOutput;
 ...
 * 
 */
public class ShowOutput extends KaixinOutput implements ThirdPartyEmotions {
	...
	public List<Arg> getEmotions() {
		...
		for (Emotion emotion : emotions) {
			returnEmotions.add(new Arg(emotion.getEmotion(),emotion.getSrc()));
		}
