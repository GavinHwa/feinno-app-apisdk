...
public class HomeTimelineInput1 extends SinaOauth1Input {
	private final static String apiURL = "http://api.t.sina.com.cn/statuses/friends_timeline.json";
	...
	public HomeTimelineInput1(String accessKey, String accessSecret, long since_id, int count, long loginIp) {
...
//		addRemoteIP(loginIp);
	...
	public HomeTimelineInput1(String accessKey, String accessSecret, long since_id, long loginIp) {
		this.since_id = since_id;
		this.hasSince_id = true;
		bodyArgs.add(new Arg("since_id",Long.toString(since_id)));
		this.userAccessToken = new AccessToken(accessKey, accessSecret);
...
//		addRemoteIP(loginIp);
	...
	public HomeTimelineInput1(String accessKey, String accessSecret, int count, long loginIp) {
...
//		addRemoteIP(loginIp);
	...
	public HomeTimelineInput1(String accessKey, String accessSecret, long since_id, int count, long loginIp, int page) {
		this.since_id = since_id;
		this.count = count;
		this.hasSince_id = true;
		this.hasCount = true;
