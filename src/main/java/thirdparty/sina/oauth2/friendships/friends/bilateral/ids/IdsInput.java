...
public class IdsInput extends SinaOauth2Input {
	final private static String apiURL = "https://api.weibo.com/2/friendships/friends/bilateral/ids.json";
	...
	public IdsInput(String access_token, String uid){
    ...
    public IdsInput(String access_token, String uid, int count, int page){
	...
	public IdsInput(String access_token, String uid, int count, int page, int sort){
