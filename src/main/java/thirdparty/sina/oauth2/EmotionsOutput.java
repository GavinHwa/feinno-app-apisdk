...
import thirdparty.sina.Emotion;
 ...
 * 
 */
public class EmotionsOutput extends SinaOauth2Output implements ThirdPartyEmotions {
	...
	public List<Arg> getEmotions() {
		...
		for (Emotion emotion : emotions) {
			returnEmotions.add(new Arg(emotion.getPhrase(),emotion.getUrl()));
		}
