...
public class UserTimelineInput extends SinaOauth2Input {
	final private static String apiURL = "https://api.weibo.com/2/statuses/user_timeline.json";
	private String access_token;// 采用OAuth授权方式为必填参数，其他授权方式不需要此参数，OAuth授权后获得。
	private String uid;//需要查询的用户ID。
	...
	public UserTimelineInput(String access_token,long since_id,int count){
	...
	public UserTimelineInput(String access_token,long since_id){
		this.access_token = access_token;
		this.since_id = since_id;
		httpMethod = "GET";
	...
	public UserTimelineInput(String access_token,int count){
		this.access_token = access_token;
		this.since_id = 0;
		this.count = count;
		httpMethod = "GET";
	...
	public UserTimelineInput(String access_token,long since_id,int count,int page){
		this.access_token = access_token;
		this.since_id = since_id;
		this.count = count;
		this.page = page;
